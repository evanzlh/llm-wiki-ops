...
The canonical protocol takes precedence over task-skill conflicts. Fail closed
on missing or invalid configuration. All knowledge writes use transactions.
