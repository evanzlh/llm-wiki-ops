...
7. On failure, refresh `<wiki-cli> transaction show <id> --json --pretty`; require the trusted envelope ID and status to match the record and satisfy its reported action requirements. No trusted ID is inspection-only; mismatch or ambiguity stops.
